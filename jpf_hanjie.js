...
//Definition of the function that will change the puzzle based on which button was called
...
// Definition of the setupPuzzle() function which turn all cells gold and get them ready for various events
...
function setupPuzzle() {
   ...
   // Create an object collection (arrays of just the filled cells and just the empty cells
   ...
   document.getElementById("peek").addEventListener("click", function(){
       ...
       // Remove the hint after a certain amount time
       setTimeout(function() {
          for(let i = 0; i < puzzleCells.length; i++) {
...
// Definition of the setBackground() function to change the cell background when the user interacts with the puzzle
...
function setBackground(e) {
   ...
   //Prevent the deafult action of highlighting table text
   e.preventDefault();
...
// Definition of the endBackgroud() function which removes all previous puzzleCell Events
